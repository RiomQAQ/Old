<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>家属管理</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- <p>hello</p> -->
    <!-- 表单之上 -->
    <div>
    ...
    >
      ...
      >
        ...
        <el-form-item label="关系" prop="guanxi">
          <el-input v-model="addForm.guanxi"></el-input>
        </el-form-item>
        <el-form-item label="老人" prop="elderid">
          <el-select v-model="addForm.elderid" placeholder="请选择">
            <el-option
              v-for="item in elder"
              :key="item.id"
              :label="item.name"
        ...
        <el-form-item label="工作单位" prop="gzdanwei">
          <el-input v-model="addForm.gzdanwei"></el-input>
        </el-form-item>
    ...
    >
      ...
      >
        ...
        <el-form-item label="关系" prop="guanxi">
          <el-input v-model="editForm.guanxi"></el-input>
        </el-form-item>
        <el-form-item label="老人" prop="elderid">
          <el-select v-model="editForm.elderid" placeholder="请选择">
            <el-option
              v-for="item in elder"
              :key="item.id"
              :label="item.name"
        ...
        <el-form-item label="工作单位" prop="gzdanwei">
          <el-input v-model="editForm.gzdanwei"></el-input>
        </el-form-item>
        <el-form-item label="性别" prop="sex">
...
export default {
  ...
  methods: {
    async getElders() {
      const that = this;
      const url = that.APIurl.API.api.admin.affair.jiashu.getelder;
      await that.$http
        .get(url)
    ...
    async UrlSearch() {
      let that = this;
      const url = that.APIurl.API.api.admin.affair.jiashu.search;
      await that.$http
    ...
    async MinusConfirm(row) {
      // console.log(row);
      let that = this;
      const url = that.APIurl.API.api.admin.affair.jiashu.delete;
      await that.$http
        .delete(url + row.id)
        .then(function(response) {
    ...
    async UrlTableData() {
      let that = this;
      const url = that.APIurl.API.api.admin.affair.jiashu.get;
      await that.$http
        .get(url, {
          params: that.page,
        })
    ...
    async UrlAdd() {
      let that = this;
      const url = that.APIurl.API.api.admin.affair.jiashu.post;
    ...
    async UrlEdit() {
      let that = this;
      const url = that.APIurl.API.api.admin.affair.jiashu.put;
      await that.$http
