  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-form-item label="发布人" prop="pubren">
          <el-input v-model="addForm.pubren"></el-input>
        </el-form-item>
    ...
    >
      ...
      >
        ...
        <el-form-item label="发布人" prop="pubren">
          <el-input v-model="editForm.pubren"></el-input>
        </el-form-item>
        <el-form-item label="创建时间" prop="createtime">
          <el-date-picker
            type="date"
...
export default {
  ...
  methods: {
    ...
    async UrlSearch() {
      let that = this;
      const url = that.APIurl.API.api.admin.basic.notice.search;
      await that.$http
    ...
    async MinusConfirm(row) {
      // console.log(row);
      let that = this;
      const url = that.APIurl.API.api.admin.basic.notice.delete;
      await that.$http
        .delete(url + row.id)
        .then(function(response) {
    ...
    async UrlTableData() {
      let that = this;
      const url = that.APIurl.API.api.admin.basic.notice.get;
      await that.$http
        .get(url, {
          params: that.page,
        })
    ...
    async UrlAdd() {
      let that = this;
      const url = that.APIurl.API.api.admin.basic.notice.post;
      await that.$http
    ...
    async UrlEdit() {
      let that = this;
      const url = that.APIurl.API.api.admin.basic.notice.put;
      await that.$http
