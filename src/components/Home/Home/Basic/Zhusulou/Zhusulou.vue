<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>住宿楼管理</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- <p>hello</p> -->
    <!-- 表单之上 -->
    <div>
      <el-row style="margin-top:1%">
        ...
        <el-col :span="6">
          ...
          >
            <!--搜索框  -->
            <el-form-item label="名称" prop="louname" style="margin:0px">
              <el-input v-model="searchForm.louname" size="small"></el-input>
            </el-form-item>
    ...
    >
      <el-form
        ...
        :inline="true"
      >
        <el-form-item label="公寓楼名" prop="louname">
          <el-input v-model="addForm.louname"></el-input>
        </el-form-item>
      </el-form>
    ...
    >
      ...
      >
        ...
        <el-form-item label="楼名" prop="louname">
          <el-input v-model="editForm.louname"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    async UrlSearch() {
      let that = this;
      const url = that.APIurl.API.api.admin.basic.sslou.search;
      await that.$http
        .get(url + that.searchForm.louname, {
          params: that.page,
        })
    ...
    async MinusConfirm(row) {
      console.log(row);
      let that = this;
      const url = that.APIurl.API.api.admin.basic.sslou.delete;
      await that.$http
        .delete(url + row.id)
        .then(function(response) {
    ...
    async UrlTableData() {
      let that = this;
      const url = that.APIurl.API.api.admin.basic.sslou.get;
      await that.$http
        .get(url, {
          params: that.page,
        })
    ...
    async UrlAdd() {
      let that = this;
      const url = that.APIurl.API.api.admin.basic.sslou.post;
      await that.$http
    ...
    async UrlEdit() {
      let that = this;
      const url = that.APIurl.API.api.admin.basic.sslou.put;
      await that.$http
