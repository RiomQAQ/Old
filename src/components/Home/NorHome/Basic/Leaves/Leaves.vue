  ...
  <div>
    ...
    <div>
      <el-row style="margin-top:1%">
        ...
        <el-col :span="6">
          ...
          >
            <!--搜索框  -->
            <el-form-item label="事由" prop="name" style="margin:0px">
    ...
    >
      ...
      >
        ...
        <el-form-item label="姓名" prop="zgname">
          <el-input v-model="addForm.zgname"></el-input>
        </el-form-item>
        ...
        <el-form-item label="类型" prop="xtype">
          <el-input v-model="addForm.xtype"></el-input>
        </el-form-item>
        <el-form-item label="天数" prop="tianshu">
          <el-input v-model="addForm.tianshu"></el-input>
        </el-form-item>
        <el-form-item label="事由" prop="applydes">
          <el-input v-model="addForm.applydes"></el-input>
        </el-form-item>
      </el-form>
    ...
    >
      ...
      >
        ...
        <el-form-item label="类型" prop="xtype">
          <el-input v-model="editForm.xtype"></el-input>
        </el-form-item>
        <el-form-item label="天数" prop="tianshu">
          <el-input v-model="editForm.tianshu"></el-input>
        </el-form-item>
        <el-form-item label="事由" prop="applydes">
          <el-input v-model="editForm.applydes"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    async UrlSearch() {
      let that = this;
      const url = that.APIurl.API.api.normal.basic.leaves.search;
      let list = {
        accountname: sessionStorage.getItem("username"),
        ...that.page,
    ...
    async MinusConfirm(row) {
      // console.log(row);
      let that = this;
      const url = that.APIurl.API.api.normal.basic.leaves.delete;
      await that.$http
        .delete(url + row.id)
        .then(function(response) {
    ...
    async UrlTableData() {
      let that = this;
      const url = that.APIurl.API.api.normal.basic.leaves.get;
      let list = {
        accountname: sessionStorage.getItem("username"),
        ...that.page,
      };
    ...
    async UrlSslou() {
      const that = this;
      const url = that.APIurl.API.api.normal.basic.leaves.sslou;
      await that.$http
        .get(url)
        .then(function(response) {
          // console.log(response);
    ...
    async UrlAdd() {
      let that = this;
      const url = that.APIurl.API.api.normal.basic.leaves.post;
      await that.$http
    ...
    async UrlEdit() {
      let that = this;
      const url = that.APIurl.API.api.normal.basic.leaves.put;
      await that.$http
