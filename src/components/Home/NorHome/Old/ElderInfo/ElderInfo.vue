<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>老人信息查询</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- <p>hello</p> -->
    <!-- 表单之上 -->
    <div>
    ...
    >
      ...
      >
        ...
        <el-form-item label="性别" prop="sex">
          <el-select v-model="editForm.sex" disabled>
        ...
        <el-form-item label="养老补贴" prop="butie">
          <el-input v-model="editForm.butie" disabled></el-input>
        </el-form-item>
        <el-form-item label="职业" prop="zhiye">
          <el-input v-model="editForm.zhiye" disabled></el-input>
        </el-form-item>
        <el-form-item label="籍贯" prop="jiguan">
          <el-input v-model="editForm.jiguan" disabled></el-input>
        </el-form-item>
        <el-form-item label="面貌" prop="mianmao">
          <el-input v-model="editForm.mianmao" disabled></el-input>
        </el-form-item>
        <el-form-item label="社保年限" prop="ssperiod">
          <el-input v-model="editForm.ssperiod" disabled></el-input>
        </el-form-item>
        <el-form-item label="说明" prop="des">
          <el-input v-model="editForm.des" disabled></el-input>
        </el-form-item>
        <el-form-item label="余额" prop="yue">
          <el-input v-model="editForm.yue" disabled></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    async UrlSearch() {
      let that = this;
      const url = that.APIurl.API.api.normal.old.info.search;
      await that.$http
    ...
    async MinusConfirm(row) {
      // console.log(row);
      let that = this;
      const url = that.APIurl.API.api.normal.old.info.delete;
      await that.$http
        .delete(url + row.id)
        .then(function(response) {
    ...
    async UrlTableData() {
      let that = this;
      const url = that.APIurl.API.api.normal.old.info.get;
      await that.$http
        .get(url, {
          params: that.page,
        })
    ...
    async UrlSslou() {
      const that = this;
      const url = that.APIurl.API.api.normal.old.info.sslou;
      await that.$http
        .get(url)
        .then(function(response) {
          // console.log(response);
    ...
    async UrlAdd() {
      let that = this;
      const url = that.APIurl.API.api.normal.old.info.post;
      await that.$http
    ...
    async UrlEdit() {
      let that = this;
      const url = that.APIurl.API.api.normal.old.info.put;
      await that.$http
